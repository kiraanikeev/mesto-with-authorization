...
return(
        ...
        <div className={styles.element}>
          ...
          <button className={isLiked ? styles.likeActive : styles.like} onClick={handleLike} type="button"></button>
          <button className={isOwn ? styles.delete : styles.deleteHidden} onClick={handelDelet} type="button"></button>
