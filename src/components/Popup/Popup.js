...
function Popup(props) {
  ...
  return (
    <div>
      <section
        className={props.activeAddPlace ? styles.active : styles.popup}
        onClick={() => props.addPlaceSetVisible(false)}
      >
        <div className={styles.overlay}>
          ...
          >
            ...
            >
              ...
              />
              <span
                className={styles.form__input_type_error}
                id="name-error"
              ></span>
              <input
                className={styles.form__info}
              ...
              <span
                ...
                id="job-error"
              ></span>
              <button className={styles.form__btnSave} type="submit">
                Создать
              </button>
            </form>
          </div>
      ...
      <section
        className={props.activeAvatar ? styles.active : styles.popup}
        onClick={() => props.avatarSetVisible(false)}
      >
        <div className={styles.overlay}>
          <div
            className={styles.container}
      ...
      <section
        className={props.activeProfile ? styles.active : styles.popup}
        onClick={() => props.profileSetVisible(false)}
      >
        <div className={styles.overlay}>
          <div
            className={styles.container}
